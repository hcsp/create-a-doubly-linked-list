...
public class Main {
    ...
    public static LinkedListNode createDoublyLinkedList() {
        LinkedListNode head = new LinkedListNode(null, 1, null);
        LinkedListNode second = new LinkedListNode(null, 2, null);
        LinkedListNode third = new LinkedListNode(null, 3, null);
